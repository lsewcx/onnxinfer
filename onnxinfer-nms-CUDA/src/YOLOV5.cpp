    ...
    if (this->keep_ratio && srch != srcw)
    {
        ...
        if (hw_scale > 1)
        {
            ...
            *left = int((this->inpWidth - *neww) * 0.5);
            cv::copyMakeBorder(dstimg, dstimg, 0, 0, *left, this->inpWidth - *neww - *left, BORDER_CONSTANT, 114);
        }
        else
        {
            ...
            *top = (int)(this->inpHeight - *newh) * 0.5;
            cv::copyMakeBorder(dstimg, dstimg, *top, this->inpHeight - *newh - *top, 0, 0, BORDER_CONSTANT, 114);
        }
    }
    else
    {
